...
async def main() -> None:
    ...
    formats_to_test = [
        ExportFormat.MP4, ExportFormat.WEBM, ExportFormat.MOV, ExportFormat.MKV, ExportFormat.AVI,
        ...
        ExportFormat.CSS, ExportFormat.HTML, ExportFormat.TSX, ExportFormat.FRAMER_MOTION, ExportFormat.GSAP,
