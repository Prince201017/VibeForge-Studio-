...
from utils.safety_filter import enforce_diversity, moderate_text
...
class DesignGenerator:
    ...
    async def generate(
        ...
        """
        safety = moderate_text(request.prompt)
        if not safety.allowed:
            raise DesignGenerationError(safety.blocked_reason or "Prompt blocked by safety filter", blocked=True)
